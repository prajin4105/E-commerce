    ...
    @else
        ...
        <div class="mt-8 flex justify-end">
            <div class="w-full max-w-sm">
                ...
                {{-- Checkout button --}}
                <div class="space-y-4">
                    <a href="{{ route('checkout.index') }}" class="w-full inline-block text-center bg-green-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-green-700 transition duration-200 ease-in-out transform hover:scale-105">
                    ...
                    <a href="{{ route('products.index') }}" class="w-full inline-block text-center bg-gray-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-700 transition duration-200 ease-in-out">
                        Continue Shopping
                    </a>
                </div>
            </div>
